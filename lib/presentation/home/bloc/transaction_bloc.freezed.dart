...
class _$TransactionDataImpl implements _TransactionData {
  ...
  @override
  String toString() {
    return 'TransactionData(currentMonth: $currentMonth, transactions: $transactions, errorMessage: $errorMessage)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, currentMonth,
